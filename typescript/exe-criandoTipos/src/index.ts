...
function updatesSituation(situation: PlanetSituation, planet: Planet) {
...
function promptValidPlanet(callback: (planet: Planet) => void) {
    ...
    if(planet){
        ...
        alert("Planeta não encontrado. Retorne ao menu")
    }
}

function firstMenuOption() {
    const name = prompt('Informe o nome do planeta:')
    const coordinateA = Number(prompt('Informe a primeira coodernada'))
    const coordinateB = Number(prompt('Informe a segunda coodernada'))
    const coordinateC = Number(prompt('Informe a terceira coodernada'))
    const coordinateD = Number(prompt('Informe a quarta coodernada'))

    const situation = promptValidSituation()

    const conformation = confirm(`Conforma o registro do planeta ${name}? Coordenadas: (${coordinateA}, ${coordinateB}, ${coordinateC}, ${coordinateD}) Situação: ${situation}`)
...
function secondMenuOption() {
    ...
    const situation = promptValidSituation()
    updatesSituation(situation, planet)
    })
}
